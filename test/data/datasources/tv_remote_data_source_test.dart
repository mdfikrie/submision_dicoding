...
void main() {
  ...
  group('get On The Air Tv', () {
    ...
    test(
        'should return list of Tv Response Model when the response code is 200',
        () async {
      // arrange
  ...
  group('search tv', () {
    final tSearchResult = TvResponseModel.fromJson(
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/search_hulk_tv.json'), 200));
      // act
